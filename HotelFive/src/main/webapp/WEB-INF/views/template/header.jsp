   ...
   <div class="header-wrap">
         <div class="center-tab">
          ...
          <c:if test="${loginDTO ne null and loginDTO.mRight ne 1}"> 
             ...
             <c:if test="${loginDTO eq null }">
           <a id="loginout" href="javascript:void(0);" style="float: right;" onclick="fn_loginPage()"><i class="fas fa-sign-in-alt fa-2x"></i><br/>LOGIN</a>
           </c:if> 
         ...
         <div id="login" class="login-box">
            <form method="POST">
                     <h1 >LOGIN</h1><br/>
                      ...
                      <a href="javascript:void(0);" onclick="fn_resetCaptcharImg()"><i class="fas fa-redo-alt"></i></a>
